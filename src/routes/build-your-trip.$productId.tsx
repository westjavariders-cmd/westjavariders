  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Configure your experience — Cimaja Boardriders" },
      {
        ...
        content: "Choose your options and see your price before adding this experience to your cart.",
      },
...
function ConfigurePage() {
  ...
  // Recovers the single current draft; starts a new one only when none exists.
  ...
  return (
    <PublicPage>
      <Link to="/build-your-trip" className="text-xs uppercase tracking-[0.18em] text-muted-foreground">
        ← All experiences
      </Link>
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate({
                      ...
                      params: { productId: other.product_id },
                    })
                  }
                >
